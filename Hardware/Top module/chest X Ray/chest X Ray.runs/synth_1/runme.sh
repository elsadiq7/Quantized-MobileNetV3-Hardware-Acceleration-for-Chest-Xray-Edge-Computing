...
HD_PWD='C:/Users/AhmedAli/Documents/GP- Chest X Ray/chest X Ray/chest X Ray.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chest_xray_classifier_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chest_xray_classifier_top.tcl
