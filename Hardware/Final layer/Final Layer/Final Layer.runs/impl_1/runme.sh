...
HD_PWD='C:/Users/AhmedAli/Documents/Final layer/Final Layer/Final Layer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log final_layer_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source final_layer_top.tcl -notrace
