...
HD_PWD='C:/Users/AhmedAli/Documents/Final layer/Final Layer/Final Layer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log final_layer_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source final_layer_top.tcl
